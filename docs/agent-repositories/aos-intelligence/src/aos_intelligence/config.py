"""
AOS Intelligence — ML Configuration

Standalone MLConfig for the aos-intelligence package.
All settings can be overridden via environment variables (see MLConfig.from_env()).
"""
...
@dataclass
class MLConfig:
    """Configuration for the AOS ML/Intelligence pipeline."""
    ...
    # LoRAx (LoRA eXchange) multi-adapter serving
    ...
    foundry_model: str = "llama-3.3-70b"
